<script>
	import { cartViewStore, cartStore, removeProductFromCart, decreaseProductQuantityInCart, increaseProductQuantityInCart } from '$lib/utils';
...
{#if $cartViewStore}
	<div
		class="absolute min-h-screen z-10"
				...
				<div class="flex flex-col h-full">
												...
												<div class="mx-auto max-w-xs space-y-4 ml-2 mt-2">
													<div>
														<div class="relative z-0 flex">
															<div on:click={ async () => await increaseProductQuantityInCart(product)}
																 on:keyup={ async () => await increaseProductQuantityInCart(product)}
															...
															/>
															<div on:click={ async () => await decreaseProductQuantityInCart(product)}
																 on:keydown={ async () => await increaseProductQuantityInCart(product)}
					...
					<div class="px-4 py-5 border-t border-gray-200 sm:p-6">
						...
						<div class="mt-5 space-y-3">
							...
							<button on:click={async () => $cartViewStore = false}
								type="button"
